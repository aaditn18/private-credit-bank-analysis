...
import { PCTrajectoryDiagrams } from './trends/PCTrajectoryDiagrams';
...
export function TrendsPanel() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 5. Trajectory / Rating / Exposure / Strategy — four-diagram block
            powered by pc_trajectory.json (generated by
            scripts/generate_pc_trajectory_data.py). Trajectory donut + rating
            bar + exposure bar + strategy two-panel, all sharing the same
            book-direction-color encoding (Expanding / Stable / Contracting /
            Pulling Back) — not management's narrative tone. */}
      <PCTrajectoryDiagrams />
